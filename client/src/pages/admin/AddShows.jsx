...
import Loading from "../../components/Loading"; // Fallback added below if this is empty
import Title from "../../components/admin/Title";
import { CheckIcon, DeleteIcon, StarIcon } from "lucide-react";
import { kConverter } from "../../lib/kConverter";

const AddShows = () => {
  const currency = import.meta.env.VITE_CURRENCY || "₹"; // fallback if env not found
  ...
  const fetchNowPlayingMovies = async () => {
    console.log("Fetching dummy shows data...");
  ...
  return nowPlayingMovies.length > 0 ? (
    <div className="min-h-screen bg-black text-white p-6">
      ...
      <p className="mt-10 mb-6 text-lg font-medium">Now Playing Movies</p>
...
<div className="w-full overflow-hidden pb-4">
  <div className="flex justify-between gap-2">
    {nowPlayingMovies.map((movie) => (
      <div
        key={movie.id}
        className="flex-1 max-w-[150px] min-w-[100px] flex-shrink relative cursor-pointer 
      ...
      >
        ...
        <p className="font-medium truncate">{movie.title || "Untitled"}</p>
