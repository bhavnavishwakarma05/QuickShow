  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")]
     bg-cover bg-center h-screen'>
      ...
      <p className='max-w-md text-gray-300'>Book your movie tickets quickly and easily. Choose your favorite movie, 
        select the showtime, pick your seats, and confirm your booking — all in just a few steps. 
        Enjoy a smooth and convenient ticket booking experience.</p>
